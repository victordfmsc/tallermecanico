...
export default function TechApp() {
  ...
  return (
    <div className="p-4 md:p-6 space-y-4">
      <h1 className="text-xl font-bold" style={{ fontFamily: "var(--font-display)" }}>App Técnico</h1>
        ...
        <div className="w-[375px] h-[780px] bg-card border-2 border-border rounded-[2.5rem] overflow-hidden shadow-xl relative">
              ...
              return (
                ...
                >
                  ...
                  <p className="text-xs text-muted-foreground mt-0.5 flex items-center gap-1">
                    <Clock className="w-3 h-3" /> {job.estimatedHours}h estimadas
                  </p>
          ...
          <div className="absolute bottom-0 left-0 right-0 h-14 bg-card border-t flex items-center justify-around px-6">
            <div className="text-center">
              <ClipboardListIcon className="w-5 h-5 mx-auto text-primary" />
              <span className="text-[10px] text-primary font-medium">Tareas</span>
            </div>
            <div className="text-center">
              <Clock className="w-5 h-5 mx-auto text-muted-foreground" />
              <span className="text-[10px] text-muted-foreground">Tiempos</span>
            </div>
            <div className="text-center">
