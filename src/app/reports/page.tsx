          ...
          <CardContent className="p-0">
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
                ...
                <tbody>
                  {technicians.length > 0 ? technicians.map((tech: any, i: number) => (
                    ...
                    <tr>
                      <td colSpan={5} className="p-8 text-center text-muted-foreground">No hay datos de técnicos disponibles</td>
                    </tr>
                  )}
                </tbody>
              </table>
