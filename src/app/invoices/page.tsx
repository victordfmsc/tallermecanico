...
export default function InvoicesPage() {
  ...
  const totals = {
    pending: invoices.filter((i: any) => i.status === "pending").reduce((s: number, i: any) => s + (i.totalAmount || 0), 0),
    paid: invoices.filter((i: any) => i.status === "paid").reduce((s: number, i: any) => s + (i.totalAmount || 0), 0),
    overdue: invoices.filter((i: any) => i.status === "overdue").reduce((s: number, i: any) => s + (i.totalAmount || 0), 0),
  };
